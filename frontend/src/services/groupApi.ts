...
export async function createGroup(request: CreateGroupRequest): Promise<GroupResponse> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups`), {
    method: 'POST',
...
export async function joinGroup(request: JoinGroupRequest): Promise<GroupMemberResponse> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/join`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(request),
  });
...
export async function leaveGroup(groupId: string): Promise<void> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/${groupId}/leave`), {
    method: 'DELETE',
  });
...
export async function getMyGroups(): Promise<MyGroupsResponse[]> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/my`));
...
export async function getGroupDetails(groupId: string): Promise<GroupDetailsResponse> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/${groupId}`));
...
export async function getGroupMembers(groupId: string): Promise<GroupMemberResponse[]> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/${groupId}/members`));
...
export async function removeGroupMember(groupId: string, memberUserId: string): Promise<void> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/${groupId}/members/${memberUserId}`), {
    method: 'DELETE',
  });
...
export async function getGroupTournaments(groupId: string): Promise<GroupTournamentResponse[]> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/${groupId}/tournaments`));
...
export async function getGroupLeaderboards(groupId: string): Promise<GroupLeaderboardResponse[]> {
  const response = await apiFetch(getApiUrl(`${API_PREFIX}/groups/${groupId}/leaderboards`));
...
export async function removeGroupTournament(groupId: string, tournamentId: string): Promise<void> {
  const response = await apiFetch(
    getApiUrl(`${API_PREFIX}/groups/${groupId}/tournaments/${tournamentId}`),
    {
      method: 'DELETE',
    },
  );
